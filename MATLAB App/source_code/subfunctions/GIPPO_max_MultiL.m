function selected=GIPPO_max_MultiL(DirectoryLoadedCheckBox,...
...
for j=1:num_layers
    ...
    parfor i=1:n_iter
        [path{i},edges_visited{i}]=path_generator_randomizer_max(G,edges,nodes,max_length);
...
string="Min-based optimization correctly executed in "+t +" seconds !!";
